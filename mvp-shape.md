...
- Prosty interfejs wyświetlania przepisów, przypominający pulpit ze sticky notes (tylko podstawowe informacje + ewentualnie zdjęcie) + widok rozszerzony wybranego przepisu,
- Możliwość "zaplanowania" menu na następny dzień/kilka dni zgodnie z opisem użytkownika (np. "zaplanuj różnorodne obiady na następne 3 dni - mogą być mięsne, vege i jakaś zupa")
...
- skomplikowany, rozbudowany layout aplikacji - dominuje prostota
